...
echo "----------> vim make.inc"
echo "add -fPIC to OPTS and NOOPT"
...
make 2>&1 | tee log.make
echo "THIS WILL TAKE HOURS TO MAKE!!!!!!"
...
echo "library_dirs = /usr/local/atlas/lib" >> site.cfg
echo "include_dirs = /usr/local/atlas/include" >> site.cfg
echo "[atlas]" >> site.cfg
